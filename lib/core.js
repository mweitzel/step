var Core = {
	...
	update: function() {
		// console.log(Core.entities.length)		
		if(!Core.paused){
	...
	start: function() {
		...
		// Core.context.width = 600
		//Core.context.webkitImageSmoothingEnabled = false
		// Core.context.scale(2,2)
...
// find that shit from the entities list and destroy it... or else maybe just destroy it..?
// } 
...
//}
//
//EditableInput.prototype.downAt = function(keycode){
//
//}
//
//	downAt:function(keyCode){
